...
function animateText(){
    if (isTyping) {
        ...
        if (index>1){
            ...
            currentColor=currentColor===(document.documentElement.classList.contains ('light') ? 'black' : '#fff') ? '#f1cc35' : (document.documentElement.classList.contains('light') ? 'black' : '#fff');
